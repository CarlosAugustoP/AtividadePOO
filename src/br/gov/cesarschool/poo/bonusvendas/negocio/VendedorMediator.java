...
public class VendedorMediator {
	 ...
	 * instância do VendedorDAO, e o caixaDeBonusMediator com a instância única da
	 * classe CaixaDeBonusMediator.
	 */
	...
	public ResultadoInclusaoVendedor validar(Vendedor vendedor) {
		...
		if (nomeCompleto == null || vendedor.getNomeCompleto().trim().isEmpty()) {
