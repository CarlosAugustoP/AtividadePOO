...
public class TesteAcumuloResgateMediator extends TesteGeral {
	...
	public void testGerarNumeroCaixaBonus() {
		...
		// A data hora atualiza��o deve ser a data hora atual, atribu�da ao atributo
		// dataHoraAtualizacao
		// da CaixaDeBonus no construtor desta. N�o � um atributo controlado pelo
		// usu�rio nem pelo mediator.
