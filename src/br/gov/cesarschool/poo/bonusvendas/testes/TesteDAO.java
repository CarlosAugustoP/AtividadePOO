...
public class TesteDAO extends TesteGeral {
	...
	private static final String DIR_DAOS = IND_CUR_DIR + FILE_SEP + "src" + FILE_SEP + "br" + FILE_SEP + "gov"
			+ FILE_SEP + "cesarschool" + FILE_SEP + "poo" + FILE_SEP + "bonusvendas" + FILE_SEP + "dao" + FILE_SEP;
	...
	public void testDaoVendedor() {
		...
		Vendedor vend1 = new Vendedor(CPF_VALIDO, NOME_VALIDO, Sexo.MASCULINO, DATA_NASC_VALIDA, RENDA_VALIDA,
				new Endereco(LOGR_VALIDO, NUMERO_VALIDO, COMPL_VALIDO, CEP_VALIDO, CIDADE_VALIDA, ESTADO_VALIDO,
						PAIS_VALIDO));
		Vendedor vend2 = new Vendedor(OUTRO_CPF_VALIDO, NOME_VALIDO + SUF_NEW, Sexo.FEMININO, DATA_NASC_VALIDA,
				RENDA_VALIDA + 200.00, new Endereco(LOGR_VALIDO + SUF_NEW, NUMERO_VALIDO + 2, COMPL_VALIDO + SUF_NEW,
	...
	public void testAlteracaoNaoOkGenerica() {
		...
		Vendedor vend = new Vendedor(CPF_VALIDO, NOME_VALIDO, Sexo.MASCULINO, DATA_NASC_VALIDA, RENDA_VALIDA,
				new Endereco(LOGR_VALIDO, NUMERO_VALIDO, COMPL_VALIDO, CEP_VALIDO, CIDADE_VALIDA, ESTADO_VALIDO,
						PAIS_VALIDO));
		cadastroVend.incluir(vend, CPF_VALIDO);
		Vendedor vend1 = new Vendedor(OUTRO_CPF_VALIDO, NOME_VALIDO + SUF_NEW, Sexo.FEMININO, DATA_NASC_VALIDA,
				RENDA_VALIDA + 100.0, new Endereco(LOGR_VALIDO + SUF_NEW, NUMERO_VALIDO + 100, COMPL_VALIDO + SUF_NEW,
						CEP_VALIDO + SUF_NEW, CIDADE_VALIDA + SUF_NEW, ESTADO_VALIDO + SUF_NEW, PAIS_VALIDO + SUF_NEW));
		DAOGenerico daoVend = new DAOGenerico(Vendedor.class);
		boolean res = daoVend.alterar(vend1);
