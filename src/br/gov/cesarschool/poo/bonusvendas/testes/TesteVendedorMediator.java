...
public class TesteVendedorMediator extends TesteGeral {
	...
	private static final Vendedor[] VENDS_INVALIDOS = {
			new Vendedor(null, NOME_VALIDO + SUF_NEW, Sexo.FEMININO, OUTRA_DATA_NASC_VALIDA, RENDA_VALIDA + 2000.0,
			...
			new Vendedor("  ", NOME_VALIDO + SUF_NEW, Sexo.FEMININO, OUTRA_DATA_NASC_VALIDA, RENDA_VALIDA + 2000.0,
					new Endereco(LOGR_VALIDO + SUF_NEW, NUMERO_VALIDO, COMPL_VALIDO + SUF_NEW, CEP_VALIDO,
							CIDADE_VALIDA + SUF_NEW, ESTADO_VALIDO + SUF_NEW, PAIS_VALIDO + SUF_NEW)),
			new Vendedor("12345678901", NOME_VALIDO + SUF_NEW, Sexo.FEMININO, OUTRA_DATA_NASC_VALIDA,
					RENDA_VALIDA + 2000.0,
					new Endereco(LOGR_VALIDO + SUF_NEW, NUMERO_VALIDO, COMPL_VALIDO + SUF_NEW, CEP_VALIDO,
							CIDADE_VALIDA + SUF_NEW, ESTADO_VALIDO + SUF_NEW, PAIS_VALIDO + SUF_NEW)),
			new Vendedor(CPF_VALIDO, null, Sexo.FEMININO, OUTRA_DATA_NASC_VALIDA, RENDA_VALIDA + 2000.0,
					new Endereco(LOGR_VALIDO + SUF_NEW, NUMERO_VALIDO, COMPL_VALIDO + SUF_NEW, CEP_VALIDO,
							CIDADE_VALIDA + SUF_NEW, ESTADO_VALIDO + SUF_NEW, PAIS_VALIDO + SUF_NEW)),
			new Vendedor(CPF_VALIDO, "   ", Sexo.FEMININO, OUTRA_DATA_NASC_VALIDA, RENDA_VALIDA + 2000.0,
					new Endereco(LOGR_VALIDO + SUF_NEW, NUMERO_VALIDO, COMPL_VALIDO + SUF_NEW, CEP_VALIDO,
							CIDADE_VALIDA + SUF_NEW, ESTADO_VALIDO + SUF_NEW, PAIS_VALIDO + SUF_NEW)),
			new Vendedor(CPF_VALIDO, NOME_VALIDO + SUF_NEW, null, OUTRA_DATA_NASC_VALIDA, RENDA_VALIDA + 2000.0,
					new Endereco(LOGR_VALIDO + SUF_NEW, NUMERO_VALIDO, COMPL_VALIDO + SUF_NEW, CEP_VALIDO,
							CIDADE_VALIDA + SUF_NEW, ESTADO_VALIDO + SUF_NEW, PAIS_VALIDO + SUF_NEW)),
			new Vendedor(CPF_VALIDO, NOME_VALIDO + SUF_NEW, Sexo.FEMININO, null, RENDA_VALIDA + 2000.0,
					new Endereco(LOGR_VALIDO + SUF_NEW, NUMERO_VALIDO, COMPL_VALIDO + SUF_NEW, CEP_VALIDO,
							CIDADE_VALIDA + SUF_NEW, ESTADO_VALIDO + SUF_NEW, PAIS_VALIDO + SUF_NEW)),
			new Vendedor(CPF_VALIDO, NOME_VALIDO + SUF_NEW, Sexo.FEMININO, LocalDate.parse("2022-01-01"),
					RENDA_VALIDA + 2000.0,
					new Endereco(LOGR_VALIDO + SUF_NEW, NUMERO_VALIDO, COMPL_VALIDO + SUF_NEW, CEP_VALIDO,
							CIDADE_VALIDA + SUF_NEW, ESTADO_VALIDO + SUF_NEW, PAIS_VALIDO + SUF_NEW)),
			new Vendedor(CPF_VALIDO, NOME_VALIDO + SUF_NEW, Sexo.FEMININO, OUTRA_DATA_NASC_VALIDA, -3000.11,
					new Endereco(LOGR_VALIDO + SUF_NEW, NUMERO_VALIDO, COMPL_VALIDO + SUF_NEW, CEP_VALIDO,
							CIDADE_VALIDA + SUF_NEW, ESTADO_VALIDO + SUF_NEW, PAIS_VALIDO + SUF_NEW)),
			new Vendedor(CPF_VALIDO, NOME_VALIDO + SUF_NEW, Sexo.FEMININO, OUTRA_DATA_NASC_VALIDA,
					RENDA_VALIDA + 2000.0, null),
			new Vendedor(CPF_VALIDO, NOME_VALIDO + SUF_NEW, Sexo.FEMININO, OUTRA_DATA_NASC_VALIDA,
					RENDA_VALIDA + 2000.0,
					new Endereco(null, NUMERO_VALIDO, COMPL_VALIDO + SUF_NEW, CEP_VALIDO, CIDADE_VALIDA + SUF_NEW,
							ESTADO_VALIDO + SUF_NEW, PAIS_VALIDO + SUF_NEW)),
			new Vendedor(CPF_VALIDO, NOME_VALIDO + SUF_NEW, Sexo.FEMININO, OUTRA_DATA_NASC_VALIDA,
					RENDA_VALIDA + 2000.0,
					new Endereco(BRANCO, NUMERO_VALIDO, COMPL_VALIDO + SUF_NEW, CEP_VALIDO, CIDADE_VALIDA + SUF_NEW,
							ESTADO_VALIDO + SUF_NEW, PAIS_VALIDO + SUF_NEW)),
			new Vendedor(CPF_VALIDO, NOME_VALIDO + SUF_NEW, Sexo.FEMININO, OUTRA_DATA_NASC_VALIDA,
					RENDA_VALIDA + 2000.0,
					new Endereco("ABC", NUMERO_VALIDO, COMPL_VALIDO + SUF_NEW, CEP_VALIDO, CIDADE_VALIDA + SUF_NEW,
							ESTADO_VALIDO + SUF_NEW, PAIS_VALIDO + SUF_NEW)),
			new Vendedor(CPF_VALIDO, NOME_VALIDO + SUF_NEW, Sexo.FEMININO, OUTRA_DATA_NASC_VALIDA,
					RENDA_VALIDA + 2000.0,
					new Endereco(LOGR_VALIDO + SUF_NEW, -1, COMPL_VALIDO + SUF_NEW, CEP_VALIDO, CIDADE_VALIDA + SUF_NEW,
							ESTADO_VALIDO + SUF_NEW, PAIS_VALIDO + SUF_NEW)),
			new Vendedor(CPF_VALIDO, NOME_VALIDO + SUF_NEW, Sexo.FEMININO, OUTRA_DATA_NASC_VALIDA,
					RENDA_VALIDA + 2000.0,
					new Endereco(LOGR_VALIDO + SUF_NEW, NUMERO_VALIDO, COMPL_VALIDO + SUF_NEW, CEP_VALIDO, null,
							ESTADO_VALIDO + SUF_NEW, PAIS_VALIDO + SUF_NEW)),
			new Vendedor(CPF_VALIDO, NOME_VALIDO + SUF_NEW, Sexo.FEMININO, OUTRA_DATA_NASC_VALIDA,
					RENDA_VALIDA + 2000.0,
					new Endereco(BRANCO, NUMERO_VALIDO, COMPL_VALIDO + SUF_NEW, CEP_VALIDO, CIDADE_VALIDA + SUF_NEW,
			...
			new Vendedor(CPF_VALIDO, NOME_VALIDO + SUF_NEW, Sexo.FEMININO, OUTRA_DATA_NASC_VALIDA,
					RENDA_VALIDA + 2000.0, new Endereco(LOGR_VALIDO + SUF_NEW, NUMERO_VALIDO, COMPL_VALIDO + SUF_NEW,
							CEP_VALIDO, CIDADE_VALIDA + SUF_NEW, ESTADO_VALIDO + SUF_NEW, "   ")) };
	private static final String[] MSGS_VENDS_INVALIDOS = { CPF_NAO_INFORMADO, CPF_NAO_INFORMADO, CPF_INVALIDO,
			NOME_COMPLETO_NAO_INFORMADO, NOME_COMPLETO_NAO_INFORMADO, SEXO_NAO_INFORMADO,
			DATA_DE_NASCIMENTO_NAO_INFORMADA, DATA_DE_NASCIMENTO_INVALIDA, RENDA_MENOR_QUE_ZERO, ENDERECO_NAO_INFORMADO,
			LOGRADOURO_NAO_INFORMADO, LOGRADOURO_NAO_INFORMADO, LOGRADOURO_TEM_MENOS_DE_04_CARACTERES,
			NUMERO_MENOR_QUE_ZERO, CIDADE_NAO_INFORMADA, CIDADE_NAO_INFORMADA, ESTADO_NAO_INFORMADO,
			ESTADO_NAO_INFORMADO, PAIS_NAO_INFORMADO, PAIS_NAO_INFORMADO };

	private VendedorMediator mediator = VendedorMediator.getInstancia();

	@Test
	public void testCpfNaoPreenchido() {
		Vendedor vend = new Vendedor(null, NOME_VALIDO, Sexo.MASCULINO, DATA_NASC_VALIDA, RENDA_VALIDA, new Endereco(
				LOGR_VALIDO, NUMERO_VALIDO, COMPL_VALIDO, CEP_VALIDO, CIDADE_VALIDA, ESTADO_VALIDO, PAIS_VALIDO));
		assertInclusaoNaoRealizada(vend, CPF_NAO_INFORMADO);
		vend = new Vendedor("  ", NOME_VALIDO, Sexo.MASCULINO, DATA_NASC_VALIDA, RENDA_VALIDA, new Endereco(LOGR_VALIDO,
				NUMERO_VALIDO, COMPL_VALIDO, CEP_VALIDO, CIDADE_VALIDA, ESTADO_VALIDO, PAIS_VALIDO));
		assertInclusaoNaoRealizada(vend, CPF_NAO_INFORMADO);
	}

	@Test
	public void testCpfInvalido() {
		Vendedor vend = new Vendedor("12345678901", NOME_VALIDO, Sexo.MASCULINO, DATA_NASC_VALIDA, RENDA_VALIDA,
	...
	public void testNomeCompletoNaoInformado() {
		Vendedor vend = new Vendedor(CPF_VALIDO, null, Sexo.MASCULINO, DATA_NASC_VALIDA, RENDA_VALIDA, new Endereco(
				LOGR_VALIDO, NUMERO_VALIDO, COMPL_VALIDO, CEP_VALIDO, CIDADE_VALIDA, ESTADO_VALIDO, PAIS_VALIDO));
		assertInclusaoNaoRealizada(vend, NOME_COMPLETO_NAO_INFORMADO);
		vend = new Vendedor(CPF_VALIDO, "   ", Sexo.MASCULINO, DATA_NASC_VALIDA, RENDA_VALIDA, new Endereco(LOGR_VALIDO,
				NUMERO_VALIDO, COMPL_VALIDO, CEP_VALIDO, CIDADE_VALIDA, ESTADO_VALIDO, PAIS_VALIDO));
		assertInclusaoNaoRealizada(vend, NOME_COMPLETO_NAO_INFORMADO);
	}
	...
	public void testSexoNaoInformado() {
		Vendedor vend = new Vendedor(CPF_VALIDO, NOME_VALIDO, null, DATA_NASC_VALIDA, RENDA_VALIDA, new Endereco(
				LOGR_VALIDO, NUMERO_VALIDO, COMPL_VALIDO, CEP_VALIDO, CIDADE_VALIDA, ESTADO_VALIDO, PAIS_VALIDO));
	...
	public void testDataNascimentoNaoInformada() {
		Vendedor vend = new Vendedor(CPF_VALIDO, NOME_VALIDO, Sexo.MASCULINO, null, RENDA_VALIDA, new Endereco(
				LOGR_VALIDO, NUMERO_VALIDO, COMPL_VALIDO, CEP_VALIDO, CIDADE_VALIDA, ESTADO_VALIDO, PAIS_VALIDO));
	...
	public void testDataNascimentoInvalida() {
		Vendedor vend = new Vendedor(CPF_VALIDO, NOME_VALIDO, Sexo.MASCULINO, LocalDate.parse("2022-01-01"),
				RENDA_VALIDA, new Endereco(LOGR_VALIDO, NUMERO_VALIDO, COMPL_VALIDO, CEP_VALIDO, CIDADE_VALIDA,
	...
	public void testRendaInvalida() {
		Vendedor vend = new Vendedor(CPF_VALIDO, NOME_VALIDO, Sexo.MASCULINO, DATA_NASC_VALIDA, -3000.11, new Endereco(
				LOGR_VALIDO, NUMERO_VALIDO, COMPL_VALIDO, CEP_VALIDO, CIDADE_VALIDA, ESTADO_VALIDO, PAIS_VALIDO));
	...
	public void testEnderecoNaoInformado() {
		Vendedor vend = new Vendedor(CPF_VALIDO, NOME_VALIDO, Sexo.MASCULINO, DATA_NASC_VALIDA, RENDA_VALIDA, null);
	...
	public void testLogradouroNaoInformado() {
		Vendedor vend = new Vendedor(CPF_VALIDO, NOME_VALIDO, Sexo.MASCULINO, DATA_NASC_VALIDA, RENDA_VALIDA,
				new Endereco(null, NUMERO_VALIDO, COMPL_VALIDO, CEP_VALIDO, CIDADE_VALIDA, ESTADO_VALIDO, PAIS_VALIDO));
		assertInclusaoNaoRealizada(vend, LOGRADOURO_NAO_INFORMADO);
		vend = new Vendedor(CPF_VALIDO, NOME_VALIDO, Sexo.MASCULINO, DATA_NASC_VALIDA, RENDA_VALIDA, new Endereco(
				BRANCO, NUMERO_VALIDO, COMPL_VALIDO, CEP_VALIDO, CIDADE_VALIDA, ESTADO_VALIDO, PAIS_VALIDO));
		assertInclusaoNaoRealizada(vend, LOGRADOURO_NAO_INFORMADO);
	}
	...
	public void testLogradouroInvalido() {
		Vendedor vend = new Vendedor(CPF_VALIDO, NOME_VALIDO, Sexo.MASCULINO, DATA_NASC_VALIDA, RENDA_VALIDA,
				new Endereco("ABC", NUMERO_VALIDO, COMPL_VALIDO, CEP_VALIDO, CIDADE_VALIDA, ESTADO_VALIDO,
						PAIS_VALIDO));
	...
	public void testNumeroInvalido() {
		Vendedor vend = new Vendedor(CPF_VALIDO, NOME_VALIDO, Sexo.MASCULINO, DATA_NASC_VALIDA, RENDA_VALIDA,
				new Endereco(LOGR_VALIDO, -1, COMPL_VALIDO, CEP_VALIDO, CIDADE_VALIDA, ESTADO_VALIDO, PAIS_VALIDO));
	...
	public void testCidadeNaoInformada() {
		Vendedor vend = new Vendedor(CPF_VALIDO, NOME_VALIDO, Sexo.MASCULINO, DATA_NASC_VALIDA, RENDA_VALIDA,
				new Endereco(LOGR_VALIDO, NUMERO_VALIDO, COMPL_VALIDO, CEP_VALIDO, null, ESTADO_VALIDO, PAIS_VALIDO));
		assertInclusaoNaoRealizada(vend, CIDADE_NAO_INFORMADA);
		vend = new Vendedor(CPF_VALIDO, NOME_VALIDO, Sexo.MASCULINO, DATA_NASC_VALIDA, RENDA_VALIDA,
				new Endereco(LOGR_VALIDO, NUMERO_VALIDO, COMPL_VALIDO, CEP_VALIDO, " ", ESTADO_VALIDO, PAIS_VALIDO));
		assertInclusaoNaoRealizada(vend, CIDADE_NAO_INFORMADA);
	}
	...
	public void testEstadoNaoInformado() {
		Vendedor vend = new Vendedor(CPF_VALIDO, NOME_VALIDO, Sexo.MASCULINO, DATA_NASC_VALIDA, RENDA_VALIDA,
				new Endereco(LOGR_VALIDO, NUMERO_VALIDO, COMPL_VALIDO, CEP_VALIDO, CIDADE_VALIDA, null, PAIS_VALIDO));
		assertInclusaoNaoRealizada(vend, ESTADO_NAO_INFORMADO);
		vend = new Vendedor(CPF_VALIDO, NOME_VALIDO, Sexo.MASCULINO, DATA_NASC_VALIDA, RENDA_VALIDA,
				new Endereco(LOGR_VALIDO, NUMERO_VALIDO, COMPL_VALIDO, CEP_VALIDO, CIDADE_VALIDA, BRANCO, PAIS_VALIDO));
		assertInclusaoNaoRealizada(vend, ESTADO_NAO_INFORMADO);
	}
	...
	public void testPaisNaoInformado() {
		Vendedor vend = new Vendedor(CPF_VALIDO, NOME_VALIDO, Sexo.MASCULINO, DATA_NASC_VALIDA, RENDA_VALIDA,
				new Endereco(LOGR_VALIDO, NUMERO_VALIDO, COMPL_VALIDO, CEP_VALIDO, CIDADE_VALIDA, ESTADO_VALIDO, null));
		assertInclusaoNaoRealizada(vend, PAIS_NAO_INFORMADO);
		vend = new Vendedor(CPF_VALIDO, NOME_VALIDO, Sexo.MASCULINO, DATA_NASC_VALIDA, RENDA_VALIDA, new Endereco(
				LOGR_VALIDO, NUMERO_VALIDO, COMPL_VALIDO, CEP_VALIDO, CIDADE_VALIDA, ESTADO_VALIDO, "   "));
		assertInclusaoNaoRealizada(vend, PAIS_NAO_INFORMADO);
	}
	...
	public void testIncluirChaveDuplicada() {
		...
		Vendedor vend1 = new Vendedor(CPF_VALIDO, NOME_VALIDO + SUF_NEW, Sexo.FEMININO, DATA_NASC_VALIDA,
				RENDA_VALIDA + 100.0, new Endereco(LOGR_VALIDO + SUF_NEW, NUMERO_VALIDO + 100, COMPL_VALIDO + SUF_NEW,
						CEP_VALIDO + SUF_NEW, CIDADE_VALIDA + SUF_NEW, ESTADO_VALIDO + SUF_NEW, PAIS_VALIDO + SUF_NEW));
	...
	public void testAlterarChaveNaoExistente() {
		...
		cadastroVend.incluir(vend, CPF_VALIDO);
		cadastroCaixaBonus.incluir(caixaBonusOri, numero + BRANCO);
		Vendedor vend1 = new Vendedor(OUTRO_CPF_VALIDO, NOME_VALIDO + SUF_NEW, Sexo.FEMININO, OUTRA_DATA_NASC_VALIDA,
				RENDA_VALIDA + 100.0, new Endereco(LOGR_VALIDO + SUF_NEW, NUMERO_VALIDO + 100, COMPL_VALIDO + SUF_NEW,
						CEP_VALIDO + SUF_NEW, CIDADE_VALIDA + SUF_NEW, ESTADO_VALIDO + SUF_NEW, PAIS_VALIDO + SUF_NEW));
	...
	public void testAlterarDadosInvalidos() {
		Vendedor vendOri = new Vendedor(CPF_VALIDO, NOME_VALIDO, Sexo.MASCULINO, DATA_NASC_VALIDA, RENDA_VALIDA,
				new Endereco(LOGR_VALIDO, NUMERO_VALIDO, COMPL_VALIDO, CEP_VALIDO, CIDADE_VALIDA, ESTADO_VALIDO,
						PAIS_VALIDO));
	...
	public void testAlterarSucesso() {
		...
		cadastroVend.incluir(vend, CPF_VALIDO);
		cadastroCaixaBonus.incluir(caixaBonusOri, numero + BRANCO);
		Vendedor vend1 = new Vendedor(CPF_VALIDO, NOME_VALIDO + SUF_NEW, Sexo.FEMININO, OUTRA_DATA_NASC_VALIDA,
				RENDA_VALIDA + 100.0, new Endereco(LOGR_VALIDO + SUF_NEW, NUMERO_VALIDO + 100, COMPL_VALIDO + SUF_NEW,
						CEP_VALIDO + SUF_NEW, CIDADE_VALIDA + SUF_NEW, ESTADO_VALIDO + SUF_NEW, PAIS_VALIDO + SUF_NEW));
		String msg = mediator.alterar(vend1);
