...
public class TesteRelatorios extends TesteGeral {
	...
	private static final String DIR_MEDIATORS = IND_CUR_DIR + FILE_SEP + "src" + FILE_SEP + "br" + FILE_SEP + "gov"
			+ FILE_SEP + "cesarschool" + FILE_SEP + "poo" + FILE_SEP + "bonusvendas" + FILE_SEP + "negocio" + FILE_SEP;
	...
	public void testComparadoresImplementors() {
		Assertions.assertTrue(ComparadorVendedorNome.getInstance() instanceof Comparador);
		Assertions.assertTrue(ComparadorVendedorRenda.getInstance() instanceof Comparador);
		Assertions.assertTrue(ComparadorCaixaDeBonusSaldoDec.getInstance() instanceof Comparador);
		Assertions.assertTrue(ComparadorLancamentoBonusDHDec.getInstance() instanceof Comparator);
	}
	...
	public void testOrdenacaoGeral() {
		...
		Comparador comp = new Comparador() {
			...
			public int comparar(Object o1, Object o2) {
				return ((EntTesteOrdenacao) o1).at2.compareTo(((EntTesteOrdenacao) o2).at2);
			}
		};
	...
	public void testRelatorioCaixaDeBonus() {
		...
		testUsoComparadoresAux(ACUMULO_RESGATE_MEDIATOR_JAVA, "ComparadorCaixaDeBonusSaldoDec.getInstance()",
				STR_ORDENADORA);
	}
	...
	public void testRelatorioLancamento() {
		...
		testUsoComparadoresAux(ACUMULO_RESGATE_MEDIATOR_JAVA, "ComparadorLancamentoBonusDHDec.getInstance()",
				"Collections.sort");
	}
